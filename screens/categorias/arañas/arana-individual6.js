...
function AranaIndividual6() {
  const navigation = useNavigation();
  return (
    <ScrollView>
      <View style={styles.container}>
        <View style={{ width: "100%", height: 200, marginBottom: 10 }}>
          <ImageCarousel data={DATA[5].images} />
        </View>
        <Text style={[defaultStyles.text, styles.title]}>{DATA[5].title}</Text>
        <View style={styles.factBox}>
          ...
          <Text style={[defaultStyles.text, styles.factBox__textBox_title]}>
            ...
            <Text style={[defaultStyles.text, styles.info__text]}>
              Son arañas de hábitos diurnos, dotadas de buena visión, sus movimientos se asemejan a los de un robot y dan pequeños saltos 
            </Text>
          </View>
           <View style={styles.factBox__textBox}>
          </View>
        ...
        <View style={styles.navigationBox}>
          ...
          <View style={styles.nextBox}>
            <NextButton
               onPress={() => navigation.navigate(routes.CATEGORIA_ARAÑAD)}
            />
          </View>
        </View>
...
export default AranaIndividual6;
