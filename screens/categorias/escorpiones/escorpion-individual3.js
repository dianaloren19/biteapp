...
function EscoprionIndividual3() {
  const navigation = useNavigation();
  return (
    <ScrollView>
      <View style={styles.container}>
        <View style={{ width: "100%", height: 200, marginBottom: 10 }}>
          <ImageCarousel data={DAT[2].images} />
        </View>
        <Text style={[defaultStyles.text, styles.title]}>{DAT[2].title}</Text>
        <View style={styles.factBox}>
          ...
          <Text style={[defaultStyles.text, styles.factBox__textBox_title]}>
            ...
            <Text style={[defaultStyles.text, styles.info__text]}>
              Ejemplar hembra que habita en la hojarasca del bosque en el municipio de Rivera
            </Text>
          </View>
           <View style={styles.factBox__textBox}>
          </View>
...
export default EscoprionIndividual3;
